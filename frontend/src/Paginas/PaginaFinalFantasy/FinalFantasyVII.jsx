...
export const FinalFantasyFundo = styled.img`
    ...
    z-index: -10;
`
export const SecaoNota = styled.div`
    padding: 4rem;
    width: 28rem;
    height: 4rem;
...
export const Titulo4 = styled.p`
    ...
    color: white;
`
export const FinalFantasyIcon = styled.img`
    width: 27vw;
    height: 45vh;
    position: absolute;
    top: 31%;
...
export const Sinopse = styled.div`
    ...
    padding: 2%;
`
export const SinopseTexto = styled.p`
    color: white;
    text-align: center;
    font-family: sans-serif;
    font-size: 110%;
...
export const ComentarioTitulo = styled.p`
    color: white;
    text-align: center;
    font-family: sans-serif;
    font-size: 273%;
`
export const NomeUsuario1 = styled.p`
    position: absolute;
    bottom: 52%;
    margin-left: 8vw;
    width: 80vw;
...
export const IconUsuario1 = styled.img`
    width: 3vw;
    height: 6vh;
    position: absolute;
    bottom: 47%;
...
export const TextoComentario2 = styled.p`
    ...
    font-family: sans-serif;
`
export const IconUsuario2 = styled.img`
    width: 3vw;
    height: 6vh;
    position: absolute;
    bottom: 9%;
